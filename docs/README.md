...
|  功能码  | 0x0B |  1   |                                                              |
| 载荷长度 |  n   |  2   | 低字节先传                                                   |
| 载荷实体 |  n   |      | [ 消息类型 ]<br/>详情请查看[短消息类型](#短消息类型表)       |
|          |      |      | [ 消息标题 ]<br/>格式: 1B(lenght) + nB(title)<br/>lenght - 最大32B，title - UTF8编码格式 |
|          |      |      | [ 消息内容 ]<br/>格式: 1B(lenght) + nB(content)<br/>lenght - 最大100B，content - UTF8编码格式 |
|  校验码  |  CS  |  1   |                                                              |
|   包尾   | 0x16 |  1   |                                                              |
