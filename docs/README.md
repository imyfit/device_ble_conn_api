...
| ------------ | ------------------------------------------------------------ |
| **运动数据** | [1,4]     : 运动时间(本地时间)<br />[5,8]     : 运动时长(秒) <br />[9,12]   : 步数 <br />[13,16] : 距离(米)<br />[17,18] : 热量消耗(Kcal)  <br />[19]      : 最大心率  <br />[20]      : 平均心率 <br />[21,22] : 平均配速(s/km) <br />[23]      : 游泳类型(仅游泳运动) (1: 蛙泳, 2: 蝶泳, 3: 仰泳, 4: 自由泳) <br />[24,25] : 总趟数 (仅游泳运动)<br />[26,27] : 总划水次数(仅游泳运动) <br />[28,29] : 平均划水频率(strokes/min)(仅游泳运动) <br />[30,31] : 跳绳次数(仅跳绳运动) <br />[32,38] : 保留(FF)  <br />注:   若某字段数据字节均为0xFF则表明该运动类型无此项参数 |
